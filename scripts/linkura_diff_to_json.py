...
primary_key_rules = {
    ...
    "CardSkillModes": [["Id"], ["ModeOnName", "ModeOffName"]],
    ...
    # "GrandPrixRewards": [[], []],
    "GrandPrixRhythmGameSeries": [["Id"], ["Description"]],
    "HelpImages": [["Id"], ["Name"]],
    # "HomeBgms": [[], []],
    "IngameMissionSkillDetails": [["Id"], ["MissionText"]],
    "ItemExchangeCategoryDatas": [["Id"], ["ItemExchangeCategoryName"]],
    "ItemExchangeCategoryFilter": [["Id"], ["ItemExchangeCategoryName"]],
    "ItemExchangeCategoryList": [["Id"], ["CategoryListName"]],
    # "ItemExchanges": [[], []],
    ...
    "SIsCaStoreDatas": [["Id"], ["DisplayName"]],
    # "SpecialappealTokenCardSets": [[], []],
    # "SpecialRewardProgressDatas": [[], []],
    # "StageScoreMultiplierSettings": [[], []],
    # "StageSkillConditionDetails": [[], []],
    # "StageSkillConditions": [[], []],
    # "StageSkillEffectDetails": [[], []],
    # "StageSkillEffects": [[], []],
    # "StageSkillSets": [[], []],
    # "StageVoltageLevelSettings": [[], []],
    # "StageVoltageLevelThresholds": [[], []],
    "Stamps": [["Id"], ["Name"]],
