...
def translate_file(api_client: anthropic.Anthropic, file: Path, target_language: I18nLanguage, chunk_size: int = 100) -> None:
    """
    ...
    Args:
        ...
        chunk_size: Number of texts to process in each chunk (default: 100)
    """
